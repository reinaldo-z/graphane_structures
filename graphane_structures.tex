...
\subsection{Second-harmonic generation}\label{sec:shg}
...
All spectra featured here include the contribution from the nonlocal part of the pseudopotentials, as detailed in Sec. \ref{sec:shg}.
