...
[\ref{fig:upstruct}] {\upstc} structures. The dark and light spheres correspond
to carbon and hydrogen atoms, respectively.}\label{fig:structures}
\end{figure}
...
carriers appears when circularly polarized light (CPI)
...
\begin{figure}
    ...
    the direction \emph{i}, {\di}, for the hydrogenated graphene structures
...
\begin{figure}
    ...
    direction \emph{i}, {\ea}, for the hydrogenated graphene structures
...
\begin{table}
    ...
    {\altstc}                       & 0.4   & yxx   & 0.6   & *     \\
    {\upstc}                        & 0.042 & yxx   & 70    & *     \\
    Si(100)2$\times$1               & 1.5   & xxx   & 1.5   & 
    \cite{anderson2015theory} \ \\
    BN(6,0) nanotubes pristine      & 5.0   & zzz   & 35    & 
    \cite{salazar2014molecular} \\
    BN(6,0) nanotubes + 4(H$_{2}$)  & 5.0   & zzz   & 33    & 
    \cite{salazar2014molecular} \\
    BN(6,0) nanotubes + 12(H$_{2}$) & 4.8   & zzz   & 15    & 
    \cite{salazar2014molecular} \\
    \end{tabular}
    \end{ruledtabular}
\end{table}
