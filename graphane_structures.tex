...
\begin{figure}[t]
\subfloat{\includegraphics[width=\linewidth]{alt/alt-shg-abs-x.eps}}\\
\subfloat{\includegraphics[width=\linewidth]{alt/alt-shg-abs-y.eps}}
...
\begin{figure}[t]
\subfloat{\includegraphics[width=\linewidth]{up/up-shg-abs-x.eps}}\\
\subfloat{\includegraphics[width=\linewidth]{up/up-shg-abs-y.eps}}
\caption{(Color online) Spectra of the absolute value of SHG for the
