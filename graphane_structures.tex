...
% Following the same analysis we calculated the spin- and current-injection response in our structures. 
...
\subfigure[\ \label{fig:altstruct}]{
    \includegraphics[width=0.49\lw]{alt/altstruct1}
    \includegraphics[width=0.49\lw]{alt/altstruct2}}
\subfigure[\ \label{fig:upstruct}]{
    \includegraphics[width=0.49\lw]{up/upstruct1}
    \includegraphics[width=0.49\lw]{up/upstruct2}}
...
\begin{figure}[h!]
    ...
    \subfigure[\ \label{fig:alt-Da}]{
        \includegraphics[width=1\lw]{alt/alt-Da-final}}
    \subfigure[\ \label{fig:up-Da}]{
        \includegraphics[width=1\lw]{up/up-Da-final}}
...
\begin{figure}[h!]
    ...
    \subfigure[\ \label{fig:alt-eta}]{
            \includegraphics[width=1\lw]{alt/alt-eta_sm-final}}
    \subfigure[\ \label{fig:up-eta}]{
            \includegraphics[width=1\lw]{up/up_eta_sm_final}}
...
\begin{figure}[h!]
    ...
    \subfigure[\ \label{fig:alt-shg-abs}]{
            \includegraphics[width=1\lw]{alt/alt_shg_final-abs_sm}}
    \subfigure[\ \label{fig:up-shg-im}]{
            \includegraphics[width=1\lw]{alt/alt_shg_final-im_sm}}
    \subfigure[\ \label{fig:up-shg-re}]{
            \includegraphics[width=1\lw]{alt/alt_shg_final-re_sm}}
...
\begin{figure}[h!]
    ...
    \subfigure[\ \label{fig:up-shg-abs}]{
            \includegraphics[width=1\lw]{up/up_shg_final_abs_sm}}
    \subfigure[\ \label{fig:up-shg-im}]{
            \includegraphics[width=1\lw]{up/up_shg_final_im-sm}}
    \subfigure[\ \label{fig:up-shg-re}]{
            \includegraphics[width=1\lw]{up/up_shg_final_re-sm}}
