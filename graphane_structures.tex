...
\affiliation{Division of Photonics, Centro de Investigaciones en \'Optica, Le\'on, Guanajuato, M\'exico}
\author{Anatoli I. Shkrebtii}
\affiliation{University of Ontario Institute of Technology 2000 Simcoe Street North, Oshawa, Ontario, Canada L1H 7L7}
...
\caption{Top and side views of the {\altstc} and
{\upstc} structures. The light and dark spheres in figures correspond
...
\begin{figure}
    \centering
    \subfigure{
        \includegraphics[width=\lw]{alt/alt-Da-final.eps}}
    \subfigure{
        \includegraphics[width=\lw]{up/up-Da-final.eps}}
...
\begin{figure}
    ...
    \subfigure{
            \includegraphics[width=\lw]{up/up_eta_kk_final}}
    ...
    {\altstc} and {\upstc} under incidence of circularly polarized light.}\label{fig:eta}
\end{figure}
%%%% end figure eta
...
%%%% begin figure shg abs
\begin{figure}

    \centering
    \subfigure{
            \includegraphics[width=\lw]{alt/alt_shg_final-abs_sm.eps}}
    \subfigure{
            \includegraphics[width=\lw]{up/up_shg_final_abs_sm.eps}}
    \caption{(Color online) Spectra of the absolute value of SHG for the {\altstc} 
    and {\upstc} structures corresponding to the sum of the absolute 
