...
\subsection{Optical spin injection}
In Fig. \ref{fig:Da} we show the $D^{i}$ spectra for C$_{16}$H$_{8}$-alt and C$_{16}$H$_{8}$-up. Values over (under) zero define a positive (negative) direction of spin polarization along the \emph{i} direction.
For both cases, the system begins to absorb energy until the energy of the incoming light beam is major to it. For the \emph{alt} system it occurs near to 0.7185\,eV and for the \emph{up} one occurs near to 0.078\,eV of energy. 
