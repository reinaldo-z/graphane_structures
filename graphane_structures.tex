...
\begin{figure}[t]
\subfloat[The three highest values of $|\chi^{abc}(-2\omega;\omega,\omega)|$ for the \emph{alt} structure. \label{fig:shg-high-alt}]{\includegraphics[width=\linewidth]{figures/shg-vnl-alt-inset}}\\
\subfloat[Layer by layer response contribution of $|\chi^{xyy}(-2\omega;\omega,\omega)|$ for the \emph{alt} structure. \label{fig:shg-lay-alt}]{\includegraphics[width=\linewidth]{figures/shg-lay-alt}}
