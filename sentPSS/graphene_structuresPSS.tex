...
DFT in the LDA approximation. Our results show an anisotropic behavior
in the
optical responses of the 
spin, the current injection and second harmonic generation.
 We
obtained maximum absolute magnitudes of the degree of spin polarization of 61\%
and 64\% for the \emph{alt} and \emph{up} structures, respectively, and it is also
possible to optically generate an injection current coming mainly from the carbon
layer on both \emph{alt} and \emph{up} systems. Besides, we found that both
...
{\includegraphics[width=0.49\linewidth]{graph1}
\includegraphics[width=0.49\linewidth]{graph2}
\label{fig:graphenestrc}}
\\
\subfloat[Top and side view of C$_{16}$H$_{8}$-alt graphene structure.]
{\includegraphics[width=0.49\linewidth]{alt1}
\includegraphics[width=0.49\linewidth]{alt2}
\label{fig:altstrc}}
\\
\subfloat[Top and side view of C$_{16}$H$_{8}$-up graphene structure.]
{\includegraphics[width=0.49\linewidth]{up1}
\includegraphics[width=0.49\linewidth]{up2}
\label{fig:upstrc}}
...
\begin{figure}[t]
\subfloat{\includegraphics[width=\linewidth]{dsp-alt}}
\hfill
\subfloat{\includegraphics[width=\linewidth]{dsp-up}}
...
\begin{figure}[t]
\centering
\subfloat{\includegraphics[width=\linewidth]{eta-alt_x}}\\
\subfloat{\includegraphics[width=\linewidth]{eta-alt_y}}\\
\subfloat{\includegraphics[width=\linewidth]{eta-alt_z}}
...
\begin{figure}[b]
\centering
\subfloat{\includegraphics[width=\linewidth]{eta-up_x}}\\
\subfloat{\includegraphics[width=\linewidth]{eta-up_y}}\\
\subfloat{\includegraphics[width=\linewidth]{eta-up_z}}
...
{\includegraphics[width=\linewidth]{shg-vnl-up}}\\
...
{\includegraphics[width=\linewidth]{shg-lay-up}}
...
\begin{figure}[t]
\includegraphics[width=\linewidth]{band-structure-up}
...
\bibliography{graphene_structuresPSS}
